      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
        <div className="min-w-0 flex-1 space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <label className="block text-sm font-[650] text-slate-800">Versione implementata
              <input value={item.implementedVersion} onChange={event => onChange({ implementedVersion: event.target.value })} className="mt-1 block w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
            </label>
