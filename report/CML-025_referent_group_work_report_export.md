...
- `_published_snapshot/netlify-current/index.html`
  - Aggiunta blocco HTML nel pannello `referent-validation-panel`:
    ```html
    <div id="referent-validation-report" class="referent-validation-report" style="margin-top:12px;text-align:center">
      <button class="export-btn btn-md" onclick="downloadReferentGroupWorkReport()" title="Scarica report gruppo di lavoro">📄 Scarica report gruppo di lavoro</button>
    </div>
    ```
