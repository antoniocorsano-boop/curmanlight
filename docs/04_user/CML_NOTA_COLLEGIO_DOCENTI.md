# CurManLight — Nota per il Collegio Docenti
...
5. Inviare il file al coordinatore del proprio dipartimento, nei tempi stabiliti.

La proposta può essere:

- **approvata** così com'è;
- **riformulata** (modificata dal dipartimento);
- **assorbita** in altra proposta;
- **da chiarire** (resta in sospeso in attesa di approfondimento).

## Cosa faranno i dipartimenti

Il coordinatore di dipartimento raccoglierà le proposte dei docenti, le importerà in CurManLight e, dopo la discussione in riunione, registrerà l'esito per ciascuna. Al termine, scaricherà un file `.cml` con l'esito complessivo e lo invierà al referente curricolo.

## Ruolo del referente curricolo
