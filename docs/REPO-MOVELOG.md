...
- Status: MERGED_AND_PUBLISHED
- Branch: `main`
- HEAD post-merge: `9b6b83f`
- PR: #11 — merged su `main`
- Workflow Pages: `28703332554` — success
- URL pubblico: https://antoniocorsano-boop.github.io/curmanlight/ — HTTP 200
- Smoke post-publish: `br:11px`=1 (intenzionale), `br:9px`=56, `br:5px`=3
- Files created:
  - `docs/03_execution/CML-363.md`
- Files updated:
  - `docs/REPO-MOVELOG.md`
- Runtime modificato nella chiusura: NO
- Next slice: CML-364 (Pannelli speciali 12px→9px microfix)
- Verdict: `CML_363_PR11_MERGED_AND_PUBLISHED`
...
- Status: MERGED_AND_PUBLISHED
- Branch: `main`
- HEAD post-merge: `2f9436a`
- PR: #10 — merged su `main`
- Workflow Pages: `28703014543` — success
- URL pubblico: https://antoniocorsano-boop.github.io/curmanlight/ — HTTP 200
- Smoke post-publish: `br:5px`=3 (intenzionali), `br:6px`=0, `br:7px`=0, `br:8px`=109
- Files created:
  - `docs/03_execution/CML-359.md`
- Files updated:
  - `docs/REPO-MOVELOG.md`
- Verdict: `CML_359_MERGED_AND_PUBLISHED`
...
- **Backlog target**: UX-004, UX-019
- **Dipendenze**: CML-334
- **Obiettivo**: aggiungere guida contestuale minima in Didattica/Compila per chiarire cosa fare, cosa scrivere e quale risultato aspettarsi
- **Microfix runtime**:
  - inserita guida contestuale minima vicino all'area di compilazione
  - testo breve in 4 punti: azione, contenuto, risultato, supporto
  - nessuna modifica di workflow, salvataggio o esportazione
- **Runtime pair aggiornata in sincrono**:
  - `index.html`
  - `_published_snapshot/netlify-current/index.html`
...
- **File creati/modificati**:
  - `index.html`
  - `_published_snapshot/netlify-current/index.html`
  - `docs/03_execution/CML-335.md`
  - `report/CML-335_pm06_compila_contextual_help_runtime_microfix.md`
  - `docs/02_system/PROJECT-STATE.md`
  - `docs/02_system/PRODUCT-MATURITY-PROGRESS.md`
  - aggiornamento `docs/REPO-MOVELOG.md`
- **Vincoli rispettati**:
  ...
  - nessun deploy
- **Esito PM-06**: 40%
- **Prossima slice**: CML-336 (PM-06 supporto in flusso durante Compila runtime microfix)
- **Verdetto**: `CML_335_PM06_COMPILA_CONTEXTUAL_HELP_RUNTIME_MICROFIX_READY_LOCAL_NOT_PUSHED`
